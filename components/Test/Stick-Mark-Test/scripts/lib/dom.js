...
var HTMLElements = {
     ...
     */
    property: {
        accessKey: true, align: true,
        className: true, clientHeight: true, clientLeft: true, clientTop: true, clientWidth: true,
        dir: true,
        hidden: true,
        id: true, innerHTML: true, innerText: true,
        lang: true,
        offsetHeight: true, offsetLeft: true, offsetParent: true, offsetTop: true, offsetWidth: true,
        outerHTML: true, outerText: true,
        scrollHeight: true, scrollLeft: true, scrollTop: true, scrollWidth: true,
        tabIndex: true, title: true, translate: true
    },
